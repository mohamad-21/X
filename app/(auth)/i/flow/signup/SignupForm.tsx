  ...
  return (
    <div className="flex items-start lg:items-center justify-between gap-10 w-full lg:max-w-5xl max-w-lg lg:flex-row flex-col pt-7 relative">
      ...
      <div className="flex flex-col gap-7">
        <h1 className="sm:text-7xl text-5xl leading-[100px] lg:max-w-full max-w-[400px] font-bold">
          {t("happeningNow")}
        </h1>
    ...
    //         <p className="text-xs font-light text-darkgray">By signing up, you aggre the <Link href="#">Terms of Service</Link> and <Link href="#">Privacy Policy</Link>, including <Link href="#">Cookie Use</Link></p>
    //       </div>
    //       <div className="mt-12">
