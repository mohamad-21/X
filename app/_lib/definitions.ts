...
export interface User {
  ...
  account_type: "normal" | "basic" | "premium" | "premium_plus";
}
...
export const SignupSchemeFa: z.ZodType<SignupData> = z.object({
  name: z
    .string({
      errorMap: () => ({ message: "اسمتان چیست؟" }),
    })
    .trim()
    .min(1),
  email: z.string().email({
  ...
  year: z
    .string({
      errorMap: () => ({ message: "لطفا سال را انتخاب کنید" }),
    })
    .min(4),
  month: z
    .string({
      errorMap: () => ({ message: "لطفا ماه را انتخاب کنید" }),
    })
    .min(1),
  day: z
    .string({
      errorMap: () => ({ message: "لطفا روز را انتخاب کنید" }),
    })
    .min(1),
});
...
export const VerificationSchemeFa: z.ZodType<VerificationData> = z.object({
  code: z.coerce
    .number()
    .lte(99999, {
      message: "کد تایید را وارد کنید‌(۵ رفمی)",
    })
    .gte(10000, {
      message: "کد تایید را وارد کنید‌(۵ رفمی)",
    }),
...
export const PasswordSchemeFa: z.ZodType<PasswordData> = z.object({
  password: z.string().min(8, {
